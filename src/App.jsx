...
const CASE_STUDIES = [
  ...
  },
  {
    ...
    heroImage:"/portfolio/napster/napster-hero.png",
    ...
    gallery:[
      {
        ...
        images:[
          "/portfolio/napster/napster-chatbot-1.png",
          "/portfolio/napster/napster-chatbot-2.png",
      ...
      {
        label:"Design system",
        images:["/portfolio/napster/napster-design-system.png"],
        columns:1, gap:0, borderRadius:12,
      },
    ],
    impact:[
      { color:"#6A4A9A", text:"Built a unified design system with 100+ components used across Napster Spaces and Companion" },
      { color:"#4A7B9D", text:"Led a complete brand redesign, working directly with the CTO daily" },
  ...
  return (
    <div className="page-enter">
      <div className="side-pad" style={{ padding:isMobile?"88px 24px 48px":"120px 64px 72px",position:"relative",overflow:"hidden" }}>
        ...
        <p style={{ opacity:0,animation:"fadeUp 0.9s ease-out 0.55s forwards",fontFamily:"'DM Sans',sans-serif",fontSize:16,fontWeight:300,color:C.muted,marginTop:16,lineHeight:1.7 }}>Most of my work is under NDAs, but here are some projects that I've worked on!</p>
      </div>
